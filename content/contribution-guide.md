...
Try to make as many inter-document links as possible wherever appropriate. You want to make navigation easy and convenient. This also makes the graph that is built into Quartz look prettier. For example the `/electrical-home` page references the `/Electrical/drive-board` page. 
